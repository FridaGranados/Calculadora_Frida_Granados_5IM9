...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(250, 300);
		setTitle("Calculadora Simple Frida Daniela Granados Ranchos 5IM9");
		...
		nuevoBotonOperacion("+");
                 ...
                 nuevoBotonOperacion("Absoluto");
                 nuevoBotonOperacion("Cos-1");
                 nuevoBotonOperacion("Sin-1");
                 nuevoBotonOperacion("Tan-1");
	...
	private void calcularResultado() {
		...
		}else if(operacion.equals("Absoluto")){
                    resultado = Math.abs(new Double(pantalla.getText()));
                }else if(operacion.equals("Cos-1")){
                    resultado = Math.abs(new Double(pantalla.getText()));
                }else if(operacion.equals("Sin-1")){
                    resultado = Math.abs(new Double(pantalla.getText()));
                }else if(operacion.equals("Tan-1")){
                    resultado = Math.abs(new Double(pantalla.getText()));
                }
